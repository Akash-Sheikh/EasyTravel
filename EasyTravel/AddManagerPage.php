     ...
     <div class="infoBox">
        <form action="AddManager_crud.php" method="POST">
                <div class="boxField">
                    ...
                    <input class="input_field" type="text" name="Phone_number" placeholder="Phone number"/> <br/>
                    ...
                    <input class=" col-sm-6 btn btn-outline-warning btn-block" type="submit" name="submit" value="Add Manager"/><br/>
                ...
                if(isset($_GET["status"]))
                  {
                    if($_GET["status"]=="success")
                        {
                            echo "<div id='status' style='color:#ff7907'>
                            <h6>Add Success<h6>
                            </div>";
                        }
                  }
